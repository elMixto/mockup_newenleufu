...
\section{6. Cotización y Presupuesto del Proyecto}

El desarrollo se ha estructurado en \textbf{6 componentes principales}. Para mantener la máxima eficiencia de costos a favor de la Cooperativa Newen Leufü, se ha establecido un bloque cerrado de tiempo y una tarifa preferencial, entregando una plataforma completa y de última generación.

\vspace{0.3cm}
\begin{center}
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{0.95\textwidth}{|X|r|r|}
    \hline
    \textbf{Módulo Funcional / Entregable a Desarrollar} & \textbf{Horas Estimadas} & \textbf{Subtotal (CLP)} \\
    \hline
    Módulo 1: Portada (Inicio, Nosotros, Accesibilidad, Contacto) & 8 hrs & \$ 83.333 \\
    Módulo 2: Vistas Inmersivas de Experiencias (Videos y Relatos) & 8 hrs & \$ 83.333 \\
    Módulo 3: Catálogo Dinámico con Filtros (SPA Reactiva) & 8 hrs & \$ 83.333 \\
    Módulo 4: Sistema de Reservas y Calendario Interactivo & 8 hrs & \$ 83.334 \\
    Módulo 5: Pasarela de Pago Unificada (Webpay/Stripe) & 8 hrs & \$ 83.334 \\
    Módulo 6: Integración y Despliegue Global en Cloudflare Pages & 8 hrs & \$ 83.333 \\
    \hline
    \textbf{Total del Proyecto (48 horas a tarifa preferencial)} & \textbf{48 hrs} & \textbf{\$ 500.000} \\
    \hline
    \end{tabularx}
\end{center}

\vspace{0.3cm}
\noindent \textit{* Esta cotización fija de \$500.000 CLP cubre de extremo a extremo la implementación del alcance completo descrito, garantizando una arquitectura moderna de alto rendimiento, libre de mantenciones costosas de servidores (al usar Cloudflare Pages) y orientada a maximizar la conversión de ventas turísticas internacionales y locales.}
