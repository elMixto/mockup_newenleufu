...
\vspace{0.3cm}
\noindent \textit{* Esta estimación global de \$500.000 CLP y ~60 horas de esfuerzo cubre de extremo a extremo el desarrollo continuo y la puesta en marcha de la plataforma, garantizando un sitio de altísimo rendimiento, libre de mantenciones costosas de servidores tradicionales y optimizado para maximizar de forma inmediata las ventas de turismo comunitario locales e internacionales.}
