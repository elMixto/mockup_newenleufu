...
\section{6. Presupuesto Estimado y Entregables}
...
\begin{center}
    ...
    Módulo 5: Pasarela de Pago Unificada (Webpay/Stripe) & \$ 83.334 \\
    Módulo 6: Integración y Despliegue Global en Cloudflare Pages & \$ 83.333 \\
    \hline
...
\begin{itemize}
    \item \textbf{Código Fuente Total:} Propiedad intelectual y transferencia del repositorio completo alojado en GitHub.
    \item \textbf{Credenciales de Acceso:} Entrega de usuarios administradores y contraseñas de la cuenta de Cloudflare Pages, las integraciones de pasarelas de pago (Transbank/Stripe) y gestor de contenidos.
    \item \textbf{Despliegue Configurado:} Sistema en producción 100\% funcional, enlazado correctamente al dominio \texttt{newenleufu.cl} con certificado de seguridad SSL activo.
\end{itemize}

\vspace{0.3cm}
\noindent \textit{* Este presupuesto estimado de \$500.000 CLP cubre de extremo a extremo la implementación del alcance completo descrito, garantizando una arquitectura moderna de alto rendimiento, libre de mantenciones costosas de servidores (al usar Cloudflare Pages) y orientada a maximizar la conversión de ventas turísticas internacionales y locales.}
