...
\vspace{0.3cm}
La distribución referencial de valor para cada uno de los componentes funcionales se detalla a continuación:
...
\begin{center}
    ...
    \hline
    \textbf{Módulo Funcional / Entregable a Desarrollar} & \textbf{Valor Estimado (CLP)} \\
    \hline
    Módulo 1: Portada (Inicio, Nosotros, Accesibilidad, Contacto) & \$ 83.333 \\
    Módulo 2: Vistas Inmersivas de Experiencias (Videos y Relatos) & \$ 83.333 \\
    Módulo 3: Catálogo Dinámico con Filtros (SPA Reactiva) & \$ 83.333 \\
    Módulo 4: Sistema de Reservas y Calendario Interactivo & \$ 83.334 \\
    Módulo 5: Pasarela de Pago Unificada y Segura & \$ 83.334 \\
    Módulo 6: Integración y Despliegue Global en Producción & \$ 83.333 \\
    \hline
    \textbf{Inversión Total Estimada del Proyecto} & \textbf{\$ 500.000} \\
    \hline
    \end{tabularx}
\end{center}
