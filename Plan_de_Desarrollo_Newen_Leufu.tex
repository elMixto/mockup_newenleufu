...
\section{7. Presupuesto Estimado y Entregables}

\textit{\textbf{Nota Importante:} La presente propuesta representa un presupuesto estimado basado en el alcance definido. El proyecto contempla un esfuerzo global aproximado de \textbf{60 horas} de ingeniería, enfocándose en la entrega de valor, funcionalidad y activos digitales, más que en el cobro estricto por hora trabajada.}

\vspace{0.3cm}
El desarrollo se ha estructurado en \textbf{6 entregables principales}, consolidando un valor preferencial y accesible para la Cooperativa Newen Leufü.
...
\vspace{0.4cm}
\noindent \textbf{Bienes y Activos a Entregar (Handover):}

Al finalizar y aprobar el desarrollo, la Cooperativa recibirá la propiedad y el control total de la plataforma, incluyendo:
\begin{itemize}
    \item \textbf{Código Fuente Total:} Propiedad intelectual y transferencia del repositorio con el código fuente completo.
    \item \textbf{Credenciales de Acceso:} Entrega de usuarios administradores y contraseñas de la infraestructura de alojamiento, servicios de pago y panel de gestión.
    \item \textbf{Sitio Hosteado y Configurado:} Sistema alojado en producción, 100\% funcional y enlazado correctamente al dominio \texttt{newenleufu.cl} con certificado de seguridad SSL activo.
\end{itemize}

\vspace{0.3cm}
\noindent \textit{* Este presupuesto estimado de \$500.000 CLP cubre de extremo a extremo la implementación del alcance completo descrito, garantizando una arquitectura moderna de alto rendimiento, libre de mantenciones costosas de servidores tradicionales y orientada a maximizar la conversión de ventas turísticas internacionales y locales.}
